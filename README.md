...
## Environments
- Preview: https://main--aem-eds-fc-vass--LikoDevelopment.aem.page/
- Live: https://main--aem-eds-fc-vass--LikoDevelopment.aem.live/
...
1. Open the `aem-eds-fc-vass` directory in your favorite IDE and start coding :)
